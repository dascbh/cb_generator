class CookbooksController < ApplicationController
  ...
  private
    ...
    def cookbook_params
      params.require(:cookbook).permit(:name, :node_id, :role_id, :current_version, :description, :aix, :linux, :windows, :comments, :metadata_id, :template_id, :has_template, :released)
    end
end
